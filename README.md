...
| **[Session 2: Genome Assembly to Multiple Genome Alignment to SNPs](https://github.com/treangenlab/radmicrobes/tree/main/session2)** | - Strain-level analyses<br>- Core and whole-genome alignment<br>- Visualization of genome variation | - Parsnp, Mauve, SibeliaZ<br>- Gingr (visualization) | - Genome alignment depends on assembly quality; check assembly quality early and often!<br>- Visualize in Gingr to spot genome rearrangements and  mutational hotspots.<br>- Multiple genome alignment can scale to thousands of genomes! |
