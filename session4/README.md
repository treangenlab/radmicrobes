...
Each has advantages and disadvantages, but for our final exercise, I'm going to use `ggtree` to create a simple visual aid of our tree. Last exercise will be using [this R Markdown file](https://github.com/treangenlab/radmicrobes/blob/main/session4/RScripts/3.2_GGtree_phylogeny_example.Rmd) on your computer.
